...
@section('content_header')
    <h1><b>Listado General de Calificaciones </b></h1>
    <hr>
@stop
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Listado de Calificaciones por Asignaciones Registrados</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($asignaciones as $asignacione)
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a class="btn btn-warning btn-sm" href="{{ url('/admin/calificaciones/asignacion/'.$asignacione->id) }}"> 
                                            <i class="fas fa-list-alt"></i> Ver Calificaciones</a>
                                        </center>
                                    </td>
                                </tr>
                            @endforeach
