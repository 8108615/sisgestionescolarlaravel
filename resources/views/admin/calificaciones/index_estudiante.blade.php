...
@section('content_header')
    <h1><b>Calificaciones del Estudiante: </b> {{ $estudiante->apellidos . ' ' . $estudiante->nombres }} </h1>
    <hr>
@stop
                                    ...
                                    <tbody>
                                        @foreach ($asignaciones as $asignacione )
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('/admin/calificaciones/detalle/asignacion/'.$asignacione->id.'/estudiante/'.$estudiante->id) }}" 
                                                        class="btn btn-warning"><i class="fas fa-list-alt"></i> Ver Calificaciones</a>
                                                </td>
                                            </tr>
                                            @endif
                                        @endforeach
