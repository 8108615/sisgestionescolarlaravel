...
@section('content_header')
    <h1><b>Detalle de Reporte de Kardex de la Gestion: {{ $asignacion->gestion->nombre }} - Turno: {{ $asignacion->turno->nombre }} -
                        ...
                        <tbody>
                            @foreach ($kardexs as $kardex)
                                <tr>
                                    ...
                                    <td>{{ $kardex->asignacion->personal->apellidos . ' ' . $kardex->asignacion->personal->nombres }}</td>
                                    <td>{{ $kardex->asignacion->materia->nombre }}</td>
