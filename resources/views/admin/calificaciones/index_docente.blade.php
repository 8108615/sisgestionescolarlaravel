...
@section('content_header')
    <h1><b>Listado de Asignaciones para Calificaciones de Estudiantes </b></h1>
    <hr>
@stop
                        ...
                        <tbody>
                            @foreach ($asignaciones as $asignacione)
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a class="btn btn-warning btn-sm" href="{{ url('/admin/calificaciones/create/asignacion/'.$asignacione->id) }}"> 
