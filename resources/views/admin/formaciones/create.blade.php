                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="titulo" id="titulo"
                                                    value="{{ old('titulo') }}" placeholder="Ingrese el Titulo..." required>
                                            </div>
                                            @error('titulo')
                                                <small style="color: red">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="institucion"
                                                    ...
                                                    placeholder="Ingrese la Institucion..." required>
                                            </div>
                                            @error('institucion')
                                                <small style="color: red">{{ $message }}</small>
                                            @enderror
                                ...
                                <div class="row">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control" name="nivel" id="nivel" required>
                                                    ...
                                                    <option value="Tecnico"
                                                        {{ old('nivel') == 'Tecnico' ? 'selected' : '' }}>Tecnico</option>
                                                    <option value="Licenciatura"
                                                        {{ old('nivel') == 'Licenciatura' ? 'selected' : '' }}>
                                                        Licenciatura
                                                    </option>
                                                    <option value="Maestria"
                                                        {{ old('nivel') == 'Maestria' ? 'selected' : '' }}>Maestria</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="ano_graduacion">Fecha de Graduacion</label><b> (*)</b>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                ...
                                                <input type="date" class="form-control" name="fecha_graduacion"
                                                    id="fecha_graduacion" value="{{ old('fecha_graduacion') }}"
                                                    placeholder="Ingrese el Fecha de Graduacion..." required>
                                            </div>
