...
@section('content_header')
    <h1><b>Reporte de Kardex del Estudiante: </b> {{ $estudiante->apellidos . ' ' . $estudiante->nombres }} </h1>
    <hr>
@stop
                                    ...
                                    <tbody>
                                        @foreach ($asignaciones as $asignacione )
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('/admin/kardexs/detalle/asignacion/'.$asignacione->id.'/estudiante/'.$estudiante->id) }}" 
                                                        class="btn btn-danger"><i class="fas fa-list-alt"></i> Ver Reporte de Kardex</a>
                                                </td>
                                            </tr>
                                            @endif
                                        @endforeach
