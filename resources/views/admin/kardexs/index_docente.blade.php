...
@section('content_header')
    <h1><b>Listado de Asignaciones para Reporte de Kardex de Estudiantes </b></h1>
    <hr>
@stop
                        ...
                        <tbody>
                            @foreach ($asignaciones as $asignacione)
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a class="btn btn-danger btn-sm" href="{{ url('/admin/kardexs/create/asignacion/'.$asignacione->id) }}"> 
                                            <i class="fas fa-list-alt"></i> Ver Reporte de Kardex</a>
                                        </center>
                                    </td>
                                </tr>
                            @endforeach
