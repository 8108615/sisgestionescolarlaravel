...
class AsistenciaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ->with('mensaje', 'Se Registro la Asistencia Correctamente')
        ->with('icono', 'success');
    }
    ...
    public function update(Request $request,  $id)
    {
        ...
        return redirect()->back()
        ->with('mensaje', 'Se Actualizo la Asistencia de la Correctamente')
        ->with('icono', 'success');
    }
    ...
    public function destroy( $id)
    {
        ...
        return redirect()->back()
        ->with('mensaje', 'Se Elimino la Asistencia de la Correctamente')
        ->with('icono', 'success');
    }
}
